...
const PaymentDetailPage = () => {
  ...
  // Fallback sample data for demo (remove this when API is working)
  const samplePaymentData = {
    ...
    qrCode:
      "00020101021238590010A000000727012900069704180115V3CAS63603670280208QRIBFTTA5303704540450005802VN62370833CSBX9Y5GLS1 Thanh toan PlanBookAI63042BF2",
    ...
    transactions: [
      {
        ...
        gateway: "PAYOS",
        checkoutUrl:
          "https://pay.payos.vn/web/98a7a6a724e944c198fc8110ff488116",
        qrCode:
          "00020101021238590010A000000727012900069704180115V3CAS63603670280208QRIBFTTA5303704540450005802VN62370833CSBX9Y5GLS1 Thanh toan PlanBookAI63042BF2",
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <PaymentTemplate paymentData={paymentData || samplePaymentData} />
    </div>
  );
};
