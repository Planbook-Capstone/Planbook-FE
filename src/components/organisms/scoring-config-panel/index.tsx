    ...
    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-4 mb-6">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-lg font-calsans text-blue-800">
            ⚙️ Cấu hình thang điểm
          </h3>
          <span className="bg-blue-100 text-blue-700 px-2 py-1 rounded text-sm font-medium">
            Tổng: {calculateTotalScore().toFixed(2)} điểm
          </span>
        </div>
        {isExpanded ? (
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-3">
              ...
              <div className="grid grid-cols-3 gap-3 text-sm">
                <div className="text-center">
                  <div className="font-medium text-green-700">Phần I</div>
                  <div className="text-green-600">0.25 điểm/câu</div>
                ...
                <div className="text-center">
                  <div className="font-medium text-green-700">Phần II</div>
                  <div className="text-green-600">1.0 điểm/câu</div>
                  <div className="text-xs text-gray-500">
                    ({yesNoQuestionsCount} câu ={" "}
                    {(yesNoQuestionsCount * 1.0).toFixed(2)}đ)
                  </div>
                  <div className="text-xs text-gray-400 mt-1 p-1 bg-green-50 rounded">
                    <div className="font-medium">Cách tính điểm:</div>
                    {(() => {
                ...
                <div className="text-center">
                  <div className="font-medium text-green-700">Phần III</div>
                  <div className="text-green-600">0.25 điểm/câu</div>
                  <div className="text-xs text-gray-500">
                    ({shortQuestionsCount} câu ={" "}
                    {(shortQuestionsCount * 0.25).toFixed(2)}đ)
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500">
                    {questionsCount} câu ={" "}
                    {(questionsCount * scoringConfig.part1Score).toFixed(2)}{" "}
                    điểm
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {scoringConfig.part2ScoringType !== "standard" && (
                    <div className="text-xs text-gray-400 mt-1 p-2 bg-gray-50 rounded">
                      <div className="font-medium mb-1">Cách tính điểm:</div>
                      {(() => {
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500">
                    {shortQuestionsCount} câu ={" "}
                    {(shortQuestionsCount * scoringConfig.part3Score).toFixed(
                      2
                    )}{" "}
                    điểm
                  </p>
