...
interface ExerciseQuestionBankModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSelectQuestions: (questions: any[]) => void;
}

export const ExerciseQuestionBankModal: React.FC<
  ExerciseQuestionBankModalProps
> = ({ isOpen, onClose, onSelectQuestions }) => {
                          ...
                          <div className="flex flex-wrap gap-1 mb-2">
                            ...
                            <span
                              className={`px-2 py-1 text-xs rounded-full ${
                                question.difficultyLevel === "KNOWLEDGE"
                                  ? "bg-green-100 text-green-700"
                                  : question.difficultyLevel === "COMPREHENSION"
                                  ? "bg-yellow-100 text-yellow-700"
                                  : question.difficultyLevel === "APPLICATION"
                                  ? "bg-orange-100 text-orange-700"
                                  : "bg-red-100 text-red-700"
                              }`}
                            >
