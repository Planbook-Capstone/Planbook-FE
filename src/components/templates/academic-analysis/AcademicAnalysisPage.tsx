        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mt-6">
          ...
          <div className="space-y-3 text-gray-600">
            <div className="flex items-start space-x-3">
              ...
              <p>
                Chuẩn bị file Excel với cấu trúc: ID học sinh, Tên, Lớp, và điểm
                các môn học
              </p>
            </div>
            <div className="flex items-start space-x-3">
            ...
            <div className="flex items-start space-x-3">
              ...
              <p>
                Hệ thống sẽ tự động phân tích và hiển thị kết quả phân loại học
                lực
              </p>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <p>
                Xem các biểu đồ thống kê và đề xuất cải thiện cho từng nhóm học
                sinh
              </p>
            </div>
          </div>
